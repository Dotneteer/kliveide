...
<Image src={nonKliveProject} alt="NonKliveProject" width="248" height="155" style={{marginTop: 24}} />
...
<Image src={promoteBuildRoot} alt="BuildRootSign" width="307" height="325" style={{marginTop: 24}} />
