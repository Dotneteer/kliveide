...
When you load a project, Klive IDE automatically opens its build root file. You can turn off this feature by toggling the **IDE | IDE Settings | Open the last project at startup** option.
