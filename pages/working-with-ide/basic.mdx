...
import basicList from '../../public/images/working-with-ide/basic-list.png'

# The BASIC Listing

One of Klive IDE's unique features is that it can list the BASIC program from within the running machine's memory. You can access this view with the **IDE | Show BASIC Listing** menu command:e from 'next/image'
import basicList from '../../public/images/working-with-ide/basic-list.png'

# The BASIC Listing

One of Klive IDE's unique features is that it can list the BASIC program from within the running machine's memory. You can access this view with the **IDE | Show BASIC Listing** menu command: Image from 'next/image'
import basicList from '../../public/images/working-with-ide/basic-list.png'
...
<Image src={basicList} alt="ULA view" width={640} style={{marginTop: 24}} />
