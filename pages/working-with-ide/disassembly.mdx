...
import bpMessage from '../../public/images/working-with-ide/disassembly-breakpoint-message.png'
...
<Image src={bpMessage} alt="Breakpoint message" width={512} style={{marginTop: 24}} />
