...
/**
 * Defines the inteface of the service handling documents
 */
 export interface IDocumentService {
     ...
     */
    readonly documentRegistered: ILiteEvent<IDocumentPanel>;
  
    /**
     * Fires when a new document has been unregistered
     */
    readonly documentUnregistered: ILiteEvent<IDocumentPanel>;
  
    /**
     * Fires when the active document is about to change
     */
    readonly activeDocumentChanging: ILiteEvent<IDocumentPanel | null>;
  
    /**
     * Fires when the active document has been changed
     */
    readonly activeDocumentChanged: ILiteEvent<IDocumentPanel | null>;
