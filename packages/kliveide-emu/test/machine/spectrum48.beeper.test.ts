...
describe("ZX Spectrum 48 - Beeper", () => {
  ...
  it("Beeper sample #1", () => {
    ...
    const expected = "0111100000111110000011111000001111";
    let samples = "";
  ...
  it("Beeper sample #2", () => {
    ...
    const mh = new MemoryHelper(api, BEEPER_SAMPLE_BUFFER);
    const expected = "011111100000011111100000001111110000001111111";
    let samples = "";
    for (let i = 0; i < s.beeperSampleCount; i++) {
      samples += mh.readByte(i) === 1 ? "1" : "0";
    }
  ...
  it("Beeper with frame end", () => {
    ...
    const mh = new MemoryHelper(api, BEEPER_SAMPLE_BUFFER);
    const expected = "";
    let samples = "";
    for (let i = 0; i < s.beeperSampleCount; i++) {
      samples += mh.readByte(i) === 1 ? "1" : "0";
    }
