...
export const COLORIZATION_BUFFER = 0x0F_5500;
export const BEEPER_SAMPLE_BUFFER = 0x19_5500;
export const PSG_SAMPLE_BUFFER = 0x19_7500;
export const TAPE_DATA_BUFFER = 0x19_9500;
export const TAPE_SAVE_BUFFER = 0x23_9500;
export const BREAKPOINT_MAP = 0x24_9500;
export const MEMWRITE_MAP = 0x24_B500;
export const STEP_OUT_STACK = 0x24_D500;
