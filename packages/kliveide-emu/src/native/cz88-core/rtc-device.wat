...
(func $incZ88Rtc
  (i32.and (get_global $z88COM) (i32.const $BM_COMRESTIM#))
  if
  ...
  (i32.eqz)
  if
    (i32.and (get_global $z88TMK) (i32.const $BM_TMKTICK#))
    if
      (i32.and (get_global $z88TSTA) (i32.const $BM_TSTATICK#))
      i32.eqz
      if
        ...
        if
          ...
          (i32.or (get_global $z88TSTA) (i32.const $BM_TSTATICK#))
          set_global $z88TSTA
        end
      end
    end
  ...
  ;; Handle TIM1
  (i32.gt_u (get_global $z88TIM1) (i32.const 59))
  if
    ;; 1 minute has passed
    i32.const 0 set_global $z88TIM1

    (i32.and (get_global $z88STA) (i32.const $BM_STAFLAPOPEN#))
    (i32.eqz)
    if
      (i32.and (get_global $z88TMK) (i32.const $BM_TMKMIN#))
      if
        (i32.and (get_global $z88TSTA) (i32.const $BM_TSTAMIN#))
        i32.eqz
        if
          (i32.and (get_global $z88INT) (i32.const $BM_INTTIME#))
          if
            ...
            ;; INT.TIME interrupts are enabled, and Blink may signal it
            (i32.or (get_global $z88TSTA) (i32.const $BM_TSTAMIN#))
            set_global $z88TSTA
          end
        end
      end
    ...
    ;; Increment TIM2
    (i32.add (get_global $z88TIM2) (i32.const 1))
    set_global $z88TIM2

    (i32.gt_u (get_global $z88TIM2) (i32.const 255))
    if
      ;; 256 minutes passed
      i32.const 0 set_global $z88TIM2

      ;; Increment TIM3
      (i32.add (get_global $z88TIM3) (i32.const 1))
      set_global $z88TIM3

      (i32.gt_u (get_global $z88TIM3) (i32.const 255))
      if
        ;; 65536 minutes passed
        i32.const 0 set_global $z88TIM3

        ;; Increment TIM4
        (i32.add (get_global $z88TIM4) (i32.const 1))
        set_global $z88TIM4

        (i32.gt_u (get_global $z88TIM4) (i32.const 31))
        if
          ;; 65536 * 32 minutes passed
          i32.const 0 set_global $z88TIM4
        end        
      end
    end
  end
  ...
  if
    ...
    (i32.or (get_global $z88STA) (i32.const $BM_INTGINT#))
    set_global $z88STA
  end
)
