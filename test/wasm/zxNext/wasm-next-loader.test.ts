...
function createViewExports(
  ...
  return {
    ...
    zxnextDivMmcBeforeFetch: fn,
    zxnextDivMmcAfterFetch: fn,
    zxnextDivMmcArmNmi: fn,
    zxnextGetDivMmcPortE3Value: fn,
    zxnextGetDivMmcEnabled: fn,
    zxnextGetDivMmcEnableAutomap: fn,
    zxnextGetDivMmcConmem: fn,
    zxnextGetDivMmcMapram: fn,
    zxnextGetDivMmcBank: fn,
    zxnextGetDivMmcAutoMapActive: fn,
    zxnextGetDivMmcRequestAutomapOn: fn,
    zxnextGetDivMmcRequestAutomapOff: fn,
    zxnextGetDivMmcNmiHold: fn,
    zxnextSetSdCardInfo: fn,
    zxnextGetSdSelectedCard: fn,
    zxnextGetSdPortE7Value: fn,
    zxnextGetSdState: fn,
    zxnextGetSdCommandIndex: fn,
    zxnextGetSdLastCommand: fn,
    zxnextGetSdResponseReady: fn,
    zxnextGetSdResponseIndex: fn,
    zxnextGetSdHostCommand: fn,
    zxnextGetSdHostSector: fn,
    zxnextGetSdHostCard: fn,
    zxnextGetSdWriteBufferPtr: fn,
    zxnextGetSdWriteBufferLength: fn,
    zxnextClearSdHostCommand: fn,
    zxnextSetSdReadResponse: fn,
    zxnextSetSdWriteResponse: fn
