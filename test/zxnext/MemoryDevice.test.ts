...
const nextRom1Signature0 = [0xc3, 0x00, 0x3f, 0xff, 0xff, 0xff, 0xff, 0xff]; // 0x0000
const nextRom1Signature1 = [0xea, 0x3e, 0x01, 0x92, 0x32, 0x44, 0x5c, 0xa7]; // 0x2000
const nextRom2Signature0 = [0x18, 0x72, 0xc3, 0x9f, 0x3e, 0x00, 0x00, 0x00]; // 0x0000
const nextRom2Signature1 = [0x6f, 0x20, 0x06, 0x13, 0x7a, 0xb3, 0x20, 0x01]; // 0x2000
const nextRom3Signature0 = [0xf3, 0xaf, 0xed, 0x91, 0x02, 0x01, 0xff, 0xff]; // 0x0000
