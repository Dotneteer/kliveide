...
const nextRom1Signature1 = [0x2c, 0xc0, 0xe7, 0x18, 0xe5, 0x16, 0x00, 0xe7]; // 0x2000
const nextRom2Signature0 = [0x00, 0x18, 0xfd, 0x00, 0x00, 0x00, 0x00, 0x00]; // 0x0000
const nextRom2Signature1 = [0x41, 0x6c, 0x74, 0x5a, 0x58, 0x2e, 0x72, 0x6f]; // 0x2000
...
const AltRom0Signature0 = [0x00, 0x18, 0x08, 0x11, 0x09, 0x02, 0xc9, 0x00]; // 0x0000
const AltRom0Signature1 = [0x6e, 0x73, 0x75, 0x66, 0x66, 0x69, 0x63, 0x69]; // 0x2000
