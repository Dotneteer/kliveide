...
// The 4-channel device on the machine (ports, chaining, status, $C5, vector writes, port enable) is
// tested through the hardware interface on both cores in test/zxnext-hw/ctc/ctc.test.ts.
