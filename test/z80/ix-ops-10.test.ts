...
describe("Z80 indexed ops 10-1f", () => {
    ...
    it("0x11: ld de,NN", ()=> {
        ...
        m.initCode(
        [
            0xDD, 0x11, 0x26, 0xA9 // LD DE,A926H
        ]);
    ...
    it("0x19: add ix,de", ()=> {
        ...
        m.initCode(
        [
            0xDD, 0x21, 0x34, 0x12, // LD HL,1234H
