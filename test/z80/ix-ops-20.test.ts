...
describe("Z80 IX indexed ops 20-2f", () => {
    ...
    it("0x21: ld IX,NN", ()=> {
        ...
        m.initCode(
        [
            0xDD, 0x21, 0x26, 0xA9 // LD HL,A926H
        ]);
    ...
    it("0x22: ld (NN),ix", ()=> {
        ...
        m.initCode(
        [
            0xDD, 0x21, 0x26, 0xA9, // LD IX,A926H
    ...
    it("0x2a: ld ix,(NN)", ()=> {
        ...
        m.initCode(
        [
            0xDD, 0x2A, 0x00, 0x10 // LD HL,(1000H)
        ]);
