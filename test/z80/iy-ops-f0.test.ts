...
describe("Z80 indexed IY ops f0-ff", () => {
    ...
    it("0xF2: JP P,nn", ()=> {
        ...
        [
            0x3E, 0x32,             // LD A,32H
            0x87,                   // ADD A
            0xFD, 0xF2, 0x08, 0x00, // JP P,0008H
            0x76,                   // HALT
            0x3E, 0xAA,             // LD A,AAH
            0x76                    // HALT
        ]);
    ...
    it("0xF4: CALL P,nn", ()=> {
        ...
        [
            0x3E, 0x32,             // LD A,32H
            0x87,                   // ADD A
            0xFD, 0xF4, 0x08, 0x00, // CALL P,0008H
            0x76,                   // HALT
            0x3E, 0x24,             // LD A,24H
            0xC9                    // RET
        ]);
    ...
    it("0xFA: JP M,nn", ()=> {
        ...
        [
            0x3E, 0xC0,             // LD A,C0H
            0x87,                   // ADD A
            0xFD, 0xFA, 0x08, 0x00, // JP M,0008H
            0x76,                   // HALT
            0x3E, 0xAA,             // LD A,AAH
            0x76                    // HALT
        ]);
    ...
    it("0xFC: CALL M,nn", ()=> {
        ...
        [
            0x3E, 0xC0,             // LD A,C0H
            0x87,                   // ADD A
            0xFD, 0xFC, 0x08, 0x00, // CALL M,0007H
            0x76,                   // HALT
            0x3E, 0x24,             // LD A,24H
            0xC9                    // RET
        ]);
