...
describe("Z80 indexed IY ops d0-df", () => {
    it("0xD0: RET NC", ()=> {
        // --- Arrange
    ...
    it("0xD2: JP NC,nn #1", ()=> {
        ...
        [
            0x3E, 0x16,             // LD A,16H
            0xA7,                   // AND A
            0xFD, 0xD2, 0x08, 0x00, // JP NC,0007H
            0x76,                   // HALT
            0x3E, 0xAA,             // LD A,AAH
            0x76                    // HALT
        ]);
    ...
    it("0xD4: CALL NC,nn", ()=> {
        ...
        [
            0x3E, 0x16,             // LD A,16H
            0xA7,                   // AND A
            0xFD, 0xD4, 0x08, 0x00, // CALL NC,0008H
            0x76,                   // HALT
            0x3E, 0x24,             // LD A,24H
            0xC9                    // RET
        ]);
    ...
    it("0xDA: JP C,nn", ()=> {
        ...
        [
            0x3E, 0x16,             // LD A,16H
            0x37,                   // SCF
            0xFD, 0xDA, 0x08, 0x00, // JP C,0007H
            0x76,                   // HALT
            0x3E, 0xAA,             // LD A,AAH
            0x76                    // HALT
        ]);
    ...
    it("0xDC: CALL C,nn", ()=> {
        ...
        [
            0x3E, 0x16,             // LD A,16H
            0x37,                   // SCF
            0xFD, 0xDC, 0x08, 0x00, // CALL C,0008H
            0x76,                   // HALT
            0x3E, 0x24,             // LD A,24H
            0xC9                    // RET
        ]);
