...
import { Z80CpuNew } from "@emu/z80/Z80CpuNew";
...
/**
 * Implements a Z80CpuNew used for testing
 */
export class Z80CpuNewTestCpu extends Z80CpuNew {
  constructor (private readonly machine: Z80CpuNewTestMachine) {
    super();
  }
...
/**
 * This class implements a Z80CpuNew machine that can be used for unit testing.
 *
 * The methods of the class allow injecting and running Z80 code. Helper methods make it easy to test expected
 * behavior.
 */
export class Z80CpuNewTestMachine {
  ...
  /**
   * The Z80CpuNew of the test machine
   */
  readonly cpu: Z80CpuNew;
  ...
  constructor (public readonly runMode: RunMode = RunMode.Normal) {
    ...
    this.ioReadCount = 0;
    this.cpu = new Z80CpuNewTestCpu(this);
  }
