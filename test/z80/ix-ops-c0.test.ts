...
describe("Z80 indexed IX ops c0-cf", () => {
    ...
    it("0xC2: JP NZ,nn", ()=> {
        ...
        [
            0x3E, 0x16,             // LD A,16H
            0xB7,                   // OR A
            0xDD, 0xC2, 0x08, 0x00, // JP NZ,0007H
            0x76,                   // HALT
            0x3E, 0xAA,             // LD A,AAH
            0x76                    // HALT
        ]);
    ...
    it("0xC4: CALL NZ,nn", ()=> {
        ...
        [
            0x3E, 0x16,             // LD A,16H
            0xB7,                   // OR A
            0xDD, 0xC4, 0x08, 0x00, // CALL NZ,0008H
            0x76,                   // HALT
            0x3E, 0x24,             // LD A,24H
            0xC9                    // RET
        ]);
    ...
    it("0xCA: JP Z,nn", ()=> {
        ...
        [
            0x3E, 0x16,             // LD A,16H
            0xAF,                   // XOR A
            0xDD, 0xCA, 0x08, 0x00, // JP Z,0008H
            0x76,                   // HALT
            0x3E, 0xAA,             // LD A,AAH
            0x76                    // HALT
        ]);
    ...
    it("0xCC: CALL Z,nn", ()=> {
        ...
        [
            0x3E, 0x16,             // LD A,16H
            0xAF,                   // XOR A
            0xDD, 0xCC, 0x08, 0x00, // CALL Z,0008H
            0x76,                   // HALT
            0x3E, 0x24,             // LD A,24H
            0xC9                    // RET
        ]);
