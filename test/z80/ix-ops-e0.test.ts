...
describe("Z80 standard ops e0-ef", () => {
    ...
    it("0xE2: JP PO,nn", ()=> {
        ...
        [
            0x3E, 0x2A,             // LD A,2AH
            0x87,                   // ADD A
            0xDD, 0xE2, 0x08, 0x00, // JP PO,0007H
            0x76,                   // HALT
            0x3E, 0xAA,             // LD A,AAH
            0x76                    // HALT
        ]);
    ...
    it("0xE4: CALL PO,nn", ()=> {
        ...
        [
            0x3E, 0x2A,             // LD A,2AH
            0x87,                   // ADD A
            0xDD, 0xE4, 0x08, 0x00, // CALL PO,0008H
            0x76,                   // HALT
            0x3E, 0x24,             // LD A,24H
            0xC9                    // RET
        ]);
    ...
    it("0xEA: JP PE,nn", ()=> {
        ...
        [
            0x3E, 0x88,             // LD A,88H
            0x87,                   // ADD A
            0xDD, 0xEA, 0x08, 0x00, // JP PE,0008H
            0x76,                   // HALT
            0x3E, 0xAA,             // LD A,AAH
            0x76                    // HALT
        ]);
    ...
    it("0xEC: CALL PE,nn", ()=> {
        ...
        [
            0x3E, 0x88,             // LD A,88H
            0x87,                   // ADD A
            0xDD, 0xEC, 0x08, 0x00, // CALL PE,0008H
            0x76,                   // HALT
            0x3E, 0x24,             // LD A,24H
            0xC9                    // RET
        ]);
