...
describe("Z80 IX bit ops 20-2f", () => {
    it("0x20: SLA (IX+d),B", ()=> {
        ...
        m.initCode(
        [
            0xFD, 0xCB, OFFS, 0x20 // SLA (IX+32H),B
        ]);
        m.cpu.f &= 0xfe;
        m.cpu.iy = 0x1000;
    ...
    it("0x21: SLA (IX+d),C", ()=> {
        ...
        m.initCode(
        [
            0xFD, 0xCB, OFFS, 0x21 // SLA (IX+32H),C
        ]);
        m.cpu.f &= 0xfe;
        m.cpu.iy = 0x1000;
        m.cpu.f |= FlagsSetMask.C;
    ...
    it("0x22: SLA (IX+d),D", ()=> {
        ...
        m.initCode(
        [
            0xFD, 0xCB, OFFS, 0x22 // SLA (IX+32H),D
        ]);
        m.cpu.f &= 0xfe;
        m.cpu.iy = 0x1000;
        m.cpu.f |= FlagsSetMask.C;
    ...
    it("0x23: SLA (IX+d),E", ()=> {
        ...
        m.initCode(
        [
            0xFD, 0xCB, OFFS, 0x23 // SLA (IX+32H),E
        ]);
        m.cpu.f &= 0xfe;
        m.cpu.iy = 0x1000;
        m.cpu.f |= FlagsSetMask.C;
    ...
    it("0x24: SLA (IX+d),H", ()=> {
        ...
        m.initCode(
        [
            0xFD, 0xCB, OFFS, 0x24 // SLA (IX+32H),H
        ]);
        m.cpu.f &= 0xfe;
        m.cpu.iy = 0x1000;
        m.cpu.f |= FlagsSetMask.C;
    ...
    it("0x25: SLA (IX+d),L", ()=> {
        ...
        m.initCode(
        [
            0xFD, 0xCB, OFFS, 0x25 // SLA (IX+32H),L
        ]);
        m.cpu.f &= 0xfe;
        m.cpu.iy = 0x1000;
        m.cpu.f |= FlagsSetMask.C;
    ...
    it("0x26: SLA (IX+d)", ()=> {
        ...
        m.initCode(
        [
            0xFD, 0xCB, OFFS, 0x26 // SLA (IX+32H)
        ]);
        m.cpu.f &= 0xfe;
        m.cpu.iy = 0x1000;
        m.cpu.f |= FlagsSetMask.C;
    ...
    it("0x27: SLA (IX+d),A", ()=> {
        ...
        m.initCode(
        [
            0xFD, 0xCB, OFFS, 0x27 // SLA (IX+32H),A
        ]);
        m.cpu.f &= 0xfe;
        m.cpu.iy = 0x1000;
        m.cpu.f |= FlagsSetMask.C;
    ...
    it("0x28: SRA (IX+d),B", ()=> {
        ...
        m.initCode(
        [
            0xFD, 0xCB, OFFS, 0x28 // SRA (IX+32H),B
        ]);
        m.cpu.f &= 0xfe;
        m.cpu.iy = 0x1000;
        m.cpu.f |= FlagsSetMask.C;
    ...
    it("0x29: SRA (IX+d),C", ()=> {
        ...
        m.initCode(
        [
            0xFD, 0xCB, OFFS, 0x29 // SRA (IX+32H),C
        ]);
        m.cpu.f &= 0xfe;
        m.cpu.iy = 0x1000;
        m.cpu.f |= FlagsSetMask.C;
    ...
    it("0x2A: SRA (IX+d),D", ()=> {
        ...
        m.initCode(
        [
            0xFD, 0xCB, OFFS, 0x2A // SRA (IX+32H),D
        ]);
        m.cpu.f &= 0xfe;
        m.cpu.iy = 0x1000;
        m.cpu.f |= FlagsSetMask.C;
    ...
    it("0x2B: SRA (IX+d),E", ()=> {
        ...
        m.initCode(
        [
            0xFD, 0xCB, OFFS, 0x2B // SRA (IX+32H),E
        ]);
        m.cpu.f &= 0xfe;
        m.cpu.iy = 0x1000;
        m.cpu.f |= FlagsSetMask.C;
    ...
    it("0x2C: SRA (IX+d),H", ()=> {
        ...
        m.initCode(
        [
            0xFD, 0xCB, OFFS, 0x2C // SRA (IX+32H),H
        ]);
        m.cpu.f &= 0xfe;
        m.cpu.iy = 0x1000;
        m.cpu.f |= FlagsSetMask.C;
    ...
    it("0x2D: SRA (IX+d),L", ()=> {
        ...
        m.initCode(
        [
            0xFD, 0xCB, OFFS, 0x2D // SRA (IX+32H),L
        ]);
        m.cpu.f &= 0xfe;
        m.cpu.iy = 0x1000;
        m.cpu.f |= FlagsSetMask.C;
    ...
    it("0x2E: SRA (IX+d)", ()=> {
        ...
        m.initCode(
        [
            0xFD, 0xCB, OFFS, 0x2E // SRA (IX+32H)
        ]);
        m.cpu.f &= 0xfe;
        m.cpu.iy = 0x1000;
        m.cpu.f |= FlagsSetMask.C;
    ...
    it("0x2F: SRA (IX+d),A", ()=> {
        ...
        m.initCode(
        [
            0xFD, 0xCB, OFFS, 0x2F // SRA (IX+32H),A
        ]);
        m.cpu.f &= 0xfe;
        m.cpu.iy = 0x1000;
        m.cpu.f |= FlagsSetMask.C;
