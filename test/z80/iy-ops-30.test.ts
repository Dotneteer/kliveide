...
describe("Z80 indexed IY ops 30-3f", () => {
    ...
    it("0x31: ld sp,NN", ()=> {
        ...
        m.initCode(
        [
            0xFD, 0x31, 0x26, 0xA9 // LD SP,A926H
        ]);
    ...
    it("0x32: ld (NN),a", ()=> {
        ...
        [
            0x3E, 0xA9,       // LD A,A9H
            0xFD, 0x32, 0x00, 0x10  // LD (1000H),A
        ]);
    ...
    it("0x3a: ld a,(NN)", ()=> {
        ...
        m.initCode(
        [
            0xFD, 0x3A, 0x00, 0x10 // LD A,(1000H)
        ]);
