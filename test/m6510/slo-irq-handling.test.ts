...
describe("M6510 - SLO Interrupt Handling", () => {
  ...
  describe("SLO Absolute,X (0x1F) - Read-Modify-Write Interrupt Timing", () => {
    it("clock cycle is correct when IRQ occurs before SLO $1000,X", () => {
      // --- Arrange
      const testMachine = new M6510TestMachine(RunMode.UntilBrk);

      // Program: NOP, then SLO $1000,X to test interrupt before SLO, then BRK to stop
      const program = [
        0xea, // $8000: NOP (2 cycles)
        0x1f,
        0x00,
        0x10, // $8001: SLO $1000,X (7 cycles) --> IRQ before: 7 + 11 cycles
      ...
      testMachine.cpu.a = 0x0F; // Accumulator for OR operation
      ...
      // Trigger IRQ after NOP completes (at tact 2), before SLO starts
    ...
    it("clock cycle is correct when IRQ occurs during SLO $1000,X", () => {
      // --- Arrange
      const testMachine = new M6510TestMachine(RunMode.UntilBrk);

      // Program: NOP, then SLO $1000,X to test interrupt during SLO, then BRK to stop
      const program = [
        0xea, // $8000: NOP (2 cycles)
        0x1f,
        0x00,
        0x10, // $8001: SLO $1000,X (7 cycles) --> IRQ during: 7 + 11 cycles
        0xea, // $8004: NOP (2 cycles)
        0x00 // $8005: BRK (stops execution)
      ];
      ...
      // Trigger IRQ during SLO execution
      ...
      // Verify interrupt occurred during SLO execution
  ...
  describe("SLO Zero Page (0x07) - Read-Modify-Write Interrupt Timing", () => {
    it("clock cycle is correct when IRQ occurs before SLO $80", () => {
      // --- Arrange
      const testMachine = new M6510TestMachine(RunMode.UntilBrk);

      // Program: NOP, then SLO $80 to test interrupt before SLO, then BRK to stop
      const program = [
        0xea, // $8000: NOP (2 cycles)
        0x07,
        0x80, // $8001: SLO $80 (5 cycles) --> IRQ before: 5 + 11 cycles
    ...
    it("clock cycle is correct when IRQ occurs during SLO $90", () => {
      // --- Arrange
      const testMachine = new M6510TestMachine(RunMode.UntilBrk);

      // Program: NOP, then SLO $90 to test interrupt during SLO, then BRK to stop
      const program = [
        0xea, // $8000: NOP (2 cycles)
        0x07,
        0x90, // $8001: SLO $90 (5 cycles) --> IRQ during: 5 + 11 cycles
        0xea, // $8003: NOP (2 cycles)
        0x00 // $8004: BRK (stops execution)
      ];
  ...
  describe("SLO Absolute (0x0F) - Read-Modify-Write Interrupt Timing", () => {
    it("clock cycle is correct when IRQ occurs before SLO $2000", () => {
      // --- Arrange
      const testMachine = new M6510TestMachine(RunMode.UntilBrk);

      // Program: NOP, then SLO $2000 to test interrupt before SLO, then BRK to stop
      const program = [
        0xea, // $8000: NOP (2 cycles)
        0x0f,
        0x00,
        0x20, // $8001: SLO $2000 (6 cycles) --> IRQ before: 6 + 11 cycles
        0xea, // $8004: NOP (2 cycles)
        0x00 // $8005: BRK (stops execution)
      ];
    ...
    it("clock cycle is correct when IRQ occurs during SLO $3000", () => {
      // --- Arrange
      const testMachine = new M6510TestMachine(RunMode.UntilBrk);

      // Program: NOP, then SLO $3000 to test interrupt during SLO, then BRK to stop
      const program = [
        0xea, // $8000: NOP (2 cycles)
        0x0f,
        0x00,
        0x30, // $8001: SLO $3000 (6 cycles) --> IRQ during: 6 + 11 cycles
        0xea, // $8004: NOP (2 cycles)
        0x00 // $8005: BRK (stops execution)
      ];
  ...
  describe("SLO Zero Page,X (0x17) - Read-Modify-Write Interrupt Timing", () => {
    it("clock cycle is correct when IRQ occurs before SLO $80,X", () => {
      // --- Arrange
      const testMachine = new M6510TestMachine(RunMode.UntilBrk);

      // Program: NOP, then SLO $80,X to test interrupt before SLO, then BRK to stop
      const program = [
        0xea, // $8000: NOP (2 cycles)
        0x17,
        0x80, // $8001: SLO $80,X (6 cycles) --> IRQ before: 6 + 11 cycles
        0xea, // $8003: NOP (2 cycles)
        0x00 // $8004: BRK (stops execution)
      ];
    ...
    it("clock cycle is correct when IRQ occurs during SLO $F0,X (with zero page wrapping)", () => {
      // --- Arrange
      const testMachine = new M6510TestMachine(RunMode.UntilBrk);

      // Program: NOP, then SLO $F0,X to test interrupt during SLO with zero page wrapping, then BRK to stop
      const program = [
        0xea, // $8000: NOP (2 cycles)
        0x17,
        0xf0, // $8001: SLO $F0,X (6 cycles) --> IRQ during: 6 + 11 cycles
        0xea, // $8003: NOP (2 cycles)
        0x00 // $8004: BRK (stops execution)
      ];
