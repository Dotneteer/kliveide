...
import { Fat32DirEntry, Fat32LongFileName, FNAME_FLAG_LOST_CHARS } from "@abstractions/Fat32Types";
...
describe("Long file names", () => {
  ...
  it("getLongFatEntries works #1", () => {
    ...
    const lfn1 = entries[0] as Fat32LongFileName;
    ...
    const lfn2 = entries[1] as Fat32LongFileName;
    ...
    const lfn3 = entries[2] as Fat32DirEntry;
  ...
  it("getLongFatEntries works #14", () => {
    ...
    const lfn2 = entries[1] as Fat32DirEntry;
