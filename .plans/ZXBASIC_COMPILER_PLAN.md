...
IDE. **Phase 3 (core code generation) is next, and it is gated:** R11's four design notes must be
written and approved by the project author before its code starts. Decisions D1–D12 settled
...
**Where to start:** Phase 3 in §14, but **first R11** (§17.2): write the four design notes in
`.docs/` (`kbasic-mir.md`, `kbasic-lir-regalloc.md`, `kbasic-string-ownership.md`,
`kbasic-debug-builder.md`) and have the project author approve them; no Phase 3 code before that.
