...
<img src="/images/getting-started/new-klive-project.png" width="502" />
...
<img src="/images/getting-started/project-in-explorer.png" width="248" />
...
<img src="/images/getting-started/non-klive-project.png" width="247" />
...
<img src="/images/getting-started/build-root-sign.png" width="248" />

You can change the build root any time by right-clicking on a file and selecting the **Promote to Build Root** command.

<img src="/images/getting-started/promote-build-root.png" width="320" />
...
<img src="/images/getting-started/build-root-icons.png" width="675" />

Each of these icons carries out a particular operation:

| Icon | Operation |
| ---- | --------- |
| <img src="/images/getting-started/compile.png" width="50" /> | This command compiles the project using the build root file as the main file. This operation lets you check whether your code is free from compilation errors. |
| <img src="/images/getting-started/inject.png" width="50" /> | This command compiles the project. If the compilation is successful, it immediately injects the binary code into the memory of the paused machine. After the operation, you can resume the machine and execute the code (for example, with the `RANDOMIZE USR(<address>)` command). |
| <img src="/images/getting-started/start.png" width="50" /> | With this command, you can start the compiled code. |
| <img src="/images/getting-started/debug.png" width="50" /> | With this command, you can start the compiled code in debug mode. |
...
<img src="/images/getting-started/klive-project-in-editor.png" width="675" />
