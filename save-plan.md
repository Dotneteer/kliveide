...
- Header/data pairing rules.
- Header filename extraction.
- TZX byte serialization.
- `SAVED_TO_TAPE` equivalent event/API.
- Main-process save dialog or file write path.
- UI indication that a SAVE file was produced.
- End-to-end ROM SAVE smoke tests.
...
- No UI-specific test required unless a pure formatting helper is introduced.
