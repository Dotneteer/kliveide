---
description: "The Klive Assembler provides a powerful way to declare and apply macros in the code."
---

# Macros

The Klive Assembler provides a powerful way to declare and apply macros in the code. While in most programming languages and assemblers, the macros are preprocessor constructs and use simple
