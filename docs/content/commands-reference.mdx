...
If the NEX file's viewer is open, the label joins your other unsaved annotation edits and is kept
when you save them. If it is closed, the label is written to the `.nex.dis` file straight away.
