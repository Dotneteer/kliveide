...
<Callout type="info" emoji="💡">
Try the `BsraDemo` example. This example also demonstrates the sign-preserving behavior by 
...
<Callout type="info" emoji="💡">
Try the `BsrlDemo` example. This example also demonstrates the zero-filling behavior by 
...
<Callout type="info" emoji="💡">
Try the `BsrfDemo` example. This example also demonstrates the ones-filling behavior by 
