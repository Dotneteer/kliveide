...
export class M6510Cpu implements IM6510Cpu {
  ...
  private handleNmi() {
    ...
    this.incrementTacts(); // Cycle 1: Internal operation
    ...
    this.incrementTacts(); // Cycle 7: Internal operation
  }
