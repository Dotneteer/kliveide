...
*Want to dive deeper into the technical details? The memory management chapter explains how the Next's MMU works, the graphics chapter covers the video subsystems, and the I/O chapter details the expansion bus and peripherals. Each chapter assumes you've read this overview and understand why the Next makes the design choices it does.*
