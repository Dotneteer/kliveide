/*
 * Test-only reference copy of the fast Z80 C core from:
 * https://github.com/Dotneteer/kliveide/blob/dotneteer/groups-plan/src/emu/z80/z80.c
 *
 * This file is intentionally not linked into the production ZX Spectrum 48K
 * WASM artifact. It is used by the F0 comparison harness in
 * .plans/ZX_SPECTRUM_48_WASM_FAST_Z80_REPLACEMENT_PLAN.md.
 */
#include <stdint.h>
