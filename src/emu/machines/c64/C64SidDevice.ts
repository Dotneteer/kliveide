...
export class C64SidDevice implements IGenericDevice<IC64Machine> {
  ...
  readRegister(regIndex: number): number {
    ...
    switch (regIndex) {
      // Voice 1 registers
      case 0x00:
        return this._voice1FreqLo;
      case 0x01:
        return this._voice1FreqHi;
      case 0x02:
        return this._voice1PwLo;
      case 0x03:
        return this._voice1PwHi;
      case 0x04:
        return this._voice1Control;
      case 0x05:
        return this._voice1AttackDecay;
      case 0x06:
        return this._voice1SustainRelease;

      // Voice 2 registers
      case 0x07:
        return this._voice2FreqLo;
      case 0x08:
        return this._voice2FreqHi;
      case 0x09:
        return this._voice2PwLo;
      case 0x0a:
        return this._voice2PwHi;
      case 0x0b:
        return this._voice2Control;
      case 0x0c:
        return this._voice2AttackDecay;
      case 0x0d:
        return this._voice2SustainRelease;

      // Voice 3 registers
      case 0x0e:
        return this._voice3FreqLo;
      case 0x0f:
        return this._voice3FreqHi;
      case 0x10:
        return this._voice3PwLo;
      case 0x11:
        return this._voice3PwHi;
      case 0x12:
        return this._voice3Control;
      case 0x13:
        return this._voice3AttackDecay;
      case 0x14:
        return this._voice3SustainRelease;

      // Filter and volume registers
      case 0x15:
        return this._filterCutoffLo;
      case 0x16:
        return this._filterCutoffHi;
      case 0x17:
        return this._filterResonanceVoice;
      case 0x18:
        return this._volumeFilterMode;
      ...
      case 0x1b:
        return this._voice3OscillatorOutput;
      case 0x1c:
        return this._voice3EnvelopeOutput;
  ...
  writeRegister(regIndex: number, value: number): void {
    ...
    switch (regIndex) {
      // Voice 1 registers
      case 0x00:
        this._voice1FreqLo = value;
        break;
      case 0x01:
        this._voice1FreqHi = value;
        break;
      case 0x02:
        this._voice1PwLo = value;
        break;
      case 0x03:
        this._voice1PwHi = value & 0x0f;
        break; // Only lower 4 bits
      case 0x04:
        this._voice1Control = value;
        break;
      case 0x05:
        this._voice1AttackDecay = value;
        break;
      case 0x06:
        this._voice1SustainRelease = value;
        break;

      // Voice 2 registers
      case 0x07:
        this._voice2FreqLo = value;
        break;
      case 0x08:
        this._voice2FreqHi = value;
        break;
      case 0x09:
        this._voice2PwLo = value;
        break;
      case 0x0a:
        this._voice2PwHi = value & 0x0f;
        break; // Only lower 4 bits
      case 0x0b:
        this._voice2Control = value;
        break;
      case 0x0c:
        this._voice2AttackDecay = value;
        break;
      case 0x0d:
        this._voice2SustainRelease = value;
        break;

      // Voice 3 registers
      case 0x0e:
        this._voice3FreqLo = value;
        break;
      case 0x0f:
        this._voice3FreqHi = value;
        break;
      case 0x10:
        this._voice3PwLo = value;
        break;
      case 0x11:
        this._voice3PwHi = value & 0x0f;
        break; // Only lower 4 bits
      case 0x12:
        this._voice3Control = value;
        break;
      case 0x13:
        this._voice3AttackDecay = value;
        break;
      case 0x14:
        this._voice3SustainRelease = value;
        break;
      ...
      case 0x16:
        this._filterCutoffHi = value;
        break;
      case 0x17:
        this._filterResonanceVoice = value;
        break;
      case 0x18:
        this._volumeFilterMode = value;
        break;
