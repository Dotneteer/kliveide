...
export class C64VicDevice implements IGenericDevice<IC64Machine> {
  /**
   * Indicates if the VIC-II is in NTSC mode (true) or PAL mode (false).
   */
  private _ntscMode: boolean = false;
  /**
  ...
  readRegister(regIndex: number): number {
    ...
    switch (regIndex) {
      case 0x10: return this._spriteXMsb;
      case 0x11: return this._controlReg1;
      case 0x12: return this._rasterLine;
      case 0x13: return this._lightPenX;
      case 0x14: return this._lightPenY;
      case 0x15: return this._spriteEnable;
      case 0x16: return this._controlReg2;
      case 0x17: return this._spriteYExpand;
      case 0x18: return this._memoryPointers;
      case 0x19: return this._interruptReg;
      case 0x1A: return this._interruptEnable;
      case 0x1B: return this._spriteDataPriority;
      case 0x1C: return this._spriteMulticolor;
      case 0x1D: return this._spriteXExpand;
      case 0x1E: return this._spriteSpriteCollision;
      case 0x1F: return this._spriteDataCollision;
      case 0x20: return this._borderColor;
      case 0x21: return this._backgroundColor0;
      case 0x22: return this._backgroundColor1;
      case 0x23: return this._backgroundColor2;
      case 0x24: return this._backgroundColor3;
      case 0x25: return this._spriteMulticolor0;
      case 0x26: return this._spriteMulticolor1;
      default:
  ...
  writeRegister(regIndex: number, value: number): void {
    ...
    // Handle remaining registers
    switch (regIndex) {
      case 0x10: this._spriteXMsb = value; break;
      case 0x11: this._controlReg1 = value; break;
      case 0x12: this._rasterLine = value; break;
      case 0x13: // Light pen registers are read-only
      case 0x14: break;
      case 0x15: this._spriteEnable = value; break;
      case 0x16: this._controlReg2 = value; break;
      case 0x17: this._spriteYExpand = value; break;
      case 0x18: this._memoryPointers = value; break;
      case 0x19: 
        // Writing to interrupt register clears bits that are set in value
        this._interruptReg &= ~value;
        break;
      case 0x1A: this._interruptEnable = value; break;
      case 0x1B: this._spriteDataPriority = value; break;
      case 0x1C: this._spriteMulticolor = value; break;
      case 0x1D: this._spriteXExpand = value; break;
      case 0x1E: // Collision registers are read-only and cleared on read
      case 0x1F: break;
      case 0x20: this._borderColor = value & 0x0F; break;       // Only lower 4 bits for colors
      case 0x21: this._backgroundColor0 = value & 0x0F; break;
      case 0x22: this._backgroundColor1 = value & 0x0F; break;
      case 0x23: this._backgroundColor2 = value & 0x0F; break;
      case 0x24: this._backgroundColor3 = value & 0x0F; break;
      case 0x25: this._spriteMulticolor0 = value & 0x0F; break;
      case 0x26: this._spriteMulticolor1 = value & 0x0F; break;
      default:
        // Sprite colors ($D027-$D02E)
        if (regIndex >= 0x27 && regIndex <= 0x2E) {
