...
export class ZxSpectrum128WasmV2Machine extends ZxSpectrum128WasmHost {
  ...
  override get af(): number {
    ...
    return w ? w.sp128GetCpuAf() : super.af;
  }

  override set af(value: number) {
    super.af = value;
    this.wasmV2Runtime?.exports.sp128SetCpuAf(super.af);
  }

  override get bc(): number {
    const w = this.wasmV2Runtime?.exports;
    return w ? w.sp128GetCpuBc() : super.bc;
  }

  override set bc(value: number) {
    super.bc = value;
    this.wasmV2Runtime?.exports.sp128SetCpuBc(super.bc);
  }

  override get de(): number {
    const w = this.wasmV2Runtime?.exports;
    return w ? w.sp128GetCpuDe() : super.de;
  }

  override set de(value: number) {
    super.de = value;
    this.wasmV2Runtime?.exports.sp128SetCpuDe(super.de);
  }

  override get hl(): number {
    const w = this.wasmV2Runtime?.exports;
    return w ? w.sp128GetCpuHl() : super.hl;
  }

  override set hl(value: number) {
    super.hl = value;
    this.wasmV2Runtime?.exports.sp128SetCpuHl(super.hl);
  }

  override get af_(): number {
    const w = this.wasmV2Runtime?.exports;
    return w ? w.sp128GetCpuAfAlt() : super.af_;
  }

  override set af_(value: number) {
    super.af_ = value;
    this.wasmV2Runtime?.exports.sp128SetCpuAfAlt(super.af_);
  }

  override get bc_(): number {
    const w = this.wasmV2Runtime?.exports;
    return w ? w.sp128GetCpuBcAlt() : super.bc_;
  }

  override set bc_(value: number) {
    super.bc_ = value;
    this.wasmV2Runtime?.exports.sp128SetCpuBcAlt(super.bc_);
  }

  override get de_(): number {
    const w = this.wasmV2Runtime?.exports;
    return w ? w.sp128GetCpuDeAlt() : super.de_;
  }

  override set de_(value: number) {
    super.de_ = value;
    this.wasmV2Runtime?.exports.sp128SetCpuDeAlt(super.de_);
  }

  override get hl_(): number {
    const w = this.wasmV2Runtime?.exports;
    return w ? w.sp128GetCpuHlAlt() : super.hl_;
  }

  override set hl_(value: number) {
    super.hl_ = value;
    this.wasmV2Runtime?.exports.sp128SetCpuHlAlt(super.hl_);
  }

  override get ix(): number {
    const w = this.wasmV2Runtime?.exports;
    return w ? w.sp128GetCpuIx() : super.ix;
  }

  override set ix(value: number) {
    super.ix = value;
    this.wasmV2Runtime?.exports.sp128SetCpuIx(super.ix);
  }

  override get iy(): number {
    const w = this.wasmV2Runtime?.exports;
    return w ? w.sp128GetCpuIy() : super.iy;
  }

  override set iy(value: number) {
    super.iy = value;
    this.wasmV2Runtime?.exports.sp128SetCpuIy(super.iy);
  }

  override get ir(): number {
    const w = this.wasmV2Runtime?.exports;
    return w ? w.sp128GetCpuIr() : super.ir;
  }

  override set ir(value: number) {
    super.ir = value;
    this.wasmV2Runtime?.exports.sp128SetCpuIr(super.ir);
  }

  override get wz(): number {
    const w = this.wasmV2Runtime?.exports;
    return w ? w.sp128GetCpuWz() : super.wz;
  }

  override set wz(value: number) {
    super.wz = value;
    this.wasmV2Runtime?.exports.sp128SetCpuWz(super.wz);
  }

  override get pc(): number {
    const w = this.wasmV2Runtime?.exports;
    return w ? w.sp128GetCpuPc() : super.pc;
  }

  override set pc(value: number) {
    super.pc = value;
    this.wasmV2Runtime?.exports.sp128SetCpuPc(super.pc);
  }

  override get sp(): number {
    const w = this.wasmV2Runtime?.exports;
    return w ? w.sp128GetCpuSp() : super.sp;
  }

  override set sp(value: number) {
    super.sp = value;
    this.wasmV2Runtime?.exports.sp128SetCpuSp(super.sp);
  }
  ...
  private syncCpuFromWasmV2(runtime: Sp128WasmV2Runtime): void {
    const wasm = runtime.exports;
    super.af = wasm.sp128GetCpuAf();
    super.bc = wasm.sp128GetCpuBc();
    super.de = wasm.sp128GetCpuDe();
    super.hl = wasm.sp128GetCpuHl();
    super.ix = wasm.sp128GetCpuIx();
    super.iy = wasm.sp128GetCpuIy();
    super.pc = wasm.sp128GetCpuPc();
    super.sp = wasm.sp128GetCpuSp();
