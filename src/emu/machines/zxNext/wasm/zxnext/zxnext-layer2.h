...
static uint32_t zxnextLayer2GetActiveRamBank(void);
static uint32_t zxnextLayer2GetShadowRamBank(void);
static uint32_t zxnextLayer2GetUseShadowBank(void);
static uint32_t zxnextLayer2GetBank(void);
static uint32_t zxnextLayer2GetBankOffset(void);
static uint32_t zxnextLayer2GetEnableMappingForReads(void);
static uint32_t zxnextLayer2GetEnableMappingForWrites(void);
