import { CommonTokenType, TokenTraits } from "@main/compiler-common/common-tokens";
import { CommonAsmParser, ParsePoint } from "@main/compiler-common/common-asm-parser";
import { Operand, PartialAssemblyLine } from "@main/compiler-common/tree-nodes";
...
export class M6510AsmParser extends CommonAsmParser<M6510Node, M6510TokenType> {
  ...
  ): PartialAssemblyLine<M6510Node> | null {
    return null;
