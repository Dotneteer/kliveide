...
export class Z80Assembler extends ExpressionEvaluator {
  ...
  private async processMacroOrStructInvocation (
    ...
    if (structDef) {
      ...
      await this.processStructInvocation(
        macroOrStructStmt,
        structDef,
        allLines
      );
  ...
  private async processStatement (
    ...
    switch (stmt.type) {
      ...
      case "MacroEndStatement":
        ...
        break;
      case "LoopStatement":
        await this.processLoopStatement(
          stmt,
          allLines,
          scopeLines,
          currentLineIndex
      ...
      case "UntilStatement":
        ...
        break;
      case "ProcStatement":
        await this.processProcStatement(
          stmt,
          allLines,
          scopeLines,
          currentLineIndex
      ...
      case "NextStatement":
        ...
        break;
      case "ForStatement":
        await this.processForStatement(
          stmt,
          allLines,
          scopeLines,
          currentLineIndex
