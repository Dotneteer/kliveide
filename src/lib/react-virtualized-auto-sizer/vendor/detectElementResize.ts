...
if (cancelAnimationFrameFn == null || requestAnimationFrameFn == null) {
  ...
  requestFrame = function requestAnimationFrameViaSetTimeout(callback: any) {
  ...
  cancelFrame = function cancelFrame([animationFrameID, timeoutID]: any) {
...
export default function createDetectElementResize(nonce: any) {
  let animationKeyframes: any;
  let animationName: any;
  let animationStartEvent: any;
  let animationStyle: any;
  let checkTriggers: any;
  let resetTriggers: any;
  let scrollListener: any;

  // @ts-ignore
  const attachEvent: any = typeof document !== 'undefined' && document.attachEvent;
  if (!attachEvent) {
    resetTriggers = function(element: any) {
    ...
    checkTriggers = function(element: any) {
      return (
    ...
    scrollListener = function(e: any) {
      ...
      self.__resizeRAF__ = requestFrame(function animationFrame() {
