...
export const darkTheme: ThemeProperties = {
  ...
  // --- Context menu
  "--bgcolor-context-menu": "#282a2e",
  "--color-context-item": "#cccccc",
  "--color-context-item-dangerous": "#f14c4c",
  "--color-context-item-disabled": "#606060",
  "--bgcolor-context-item-pointed": "#3a3d44",
  "--color-context-item-pointed": "#ffffff",
  "--bgcolor-context-item-dangerous-pointed": "#4a2b30",
  "--color-context-separator": "#3b3e45",
  "--border-context-menu": "#3b3e45",
  "--shadow-context-menu": "0 8px 24px rgb(0 0 0 / 32%)",
  "--radius-context-menu": "6px",

  // --- Modal
  "--bgcolor-backdrop": "#00000080",
  "--bgcolor-modal": "#1c1e22",
  "--color-modal": "#d4d4d4",
  "--border-modal": "1px solid #363b44",
  "--border-modal-section": "1px solid #303640",
  "--shadow-modal": "0 20px 56px rgb(0 0 0 / 58%)",
  "--color-modal-accent": "#29b8db",
  "--bgimage-modal-header":
    "repeating-linear-gradient(0deg, rgb(255 255 255 / 0.025) 0 1px, transparent 1px 3px)",
  "--radius-modal": "10px",
  "--bgcolor-modal-header": "#20242a",
  "--color-modal-header": "#ffffff",
  "--bgcolor-modal-body": "#1c1e22",
  "--color-modal-body": "#d4d4d4",
  "--bgcolor-modal-footer": "#20242a",
  ...
  "--bgcolor-debug-macro-bp": "#80ff0032",
