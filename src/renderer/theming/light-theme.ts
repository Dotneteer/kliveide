...
export const lightTheme: ThemeProperties = {
  ...
  // --- Context menu
  "--bgcolor-context-menu": "#f4f5f7",
  "--color-context-item": "#414141",
  "--color-context-item-dangerous": "#cd3131",
  "--color-context-item-disabled": "#a0a0a0",
  "--bgcolor-context-item-pointed": "#e3e8f0",
  "--color-context-item-pointed": "#202020",
  "--bgcolor-context-item-dangerous-pointed": "#f9e1e1",
  "--color-context-separator": "#d3d7de",
  "--border-context-menu": "#d3d7de",
  "--shadow-context-menu": "0 8px 24px rgb(0 0 0 / 16%)",
  "--radius-context-menu": "6px",

  // --- Modal
  "--bgcolor-backdrop": "#00000040",
  "--bgcolor-modal": "#ffffff",
  "--color-modal": "#333333",
  "--border-modal": "1px solid #d3d7de",
  "--border-modal-section": "1px solid #e4e7eb",
  "--shadow-modal": "0 20px 56px rgb(0 0 0 / 18%)",
  "--color-modal-accent": "#0076c9",
  "--bgimage-modal-header": "none",
  "--radius-modal": "10px",
  "--bgcolor-modal-header": "#ffffff",
  "--color-modal-header": "#24292f",
  "--bgcolor-modal-body": "#ffffff",
  "--color-modal-body": "#414141",
  "--bgcolor-modal-footer": "#ffffff",
  "--color-modal-footer": "#24292f",
