...
export const SETTING_EMU_KEYBOARD_HEIGHTS = "emuOptions.keyboardPanelHeights";
...
export const SETTING_IDE_BP_GROUP_BY_KIND = "ideViewOptions.breakpointsGroupByKind";
