...
export type Fat32MasterBootRecord = {
  ...
  partitions: Fat32PartitionEntry[];
  // Boot sector signature
...
export function isFat32LongName(entry: Fat32DirEntry | Fat32LongFileName): entry is Fat32LongFileName {
  return (entry.hasOwnProperty("LDIR_Ord"));
}