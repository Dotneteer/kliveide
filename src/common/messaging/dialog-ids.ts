...
export const Z88_CARDS_DIALOG = EMU_DIALOG_BASE + 3;
export const Z88_REMOVE_CARD_DIALOG = EMU_DIALOG_BASE + 4;
export const Z88_INSERT_CARD_DIALOG = EMU_DIALOG_BASE + 5;
