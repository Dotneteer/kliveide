...
describe("Assembler - control flow operations", () => {
  ...
  it("jp fails", async () => {
    await codeRaisesError("jp bc", "Z0604");
    await codeRaisesError("jp de", "Z0604");
    await codeRaisesError("jp af", "Z0604");
    await codeRaisesError("jp sp", "Z0604");
    await codeRaisesError("jp (bc)", "Z0604");
    await codeRaisesError("jp (de)", "Z0604");
    await codeRaisesError("jp (sp)", "Z0604");
    await codeRaisesError("jp (ix+1)", "Z0604");
    await codeRaisesError("jp (ix-21)", "Z0604");
    await codeRaisesError("jp (iy+1)", "Z0604");
    await codeRaisesError("jp (iy-21)", "Z0604");
  });
  ...
  it("jr: fails with far address", async () => {
    // --- Start address is #8000
    await codeRaisesError("jr #8082", "Z0403");
    await codeRaisesError("jr #8100", "Z0403");
    await codeRaisesError("jr #7F81", "Z0403");
    await codeRaisesError("jr #7F00", "Z0403");

    await codeRaisesError("jr nz,#8082", "Z0403");
    await codeRaisesError("jr nz,#8100", "Z0403");
    await codeRaisesError("jr nz,#7F81", "Z0403");
    await codeRaisesError("jr nz,#7F00", "Z0403");

    await codeRaisesError("jr z,#8082", "Z0403");
    await codeRaisesError("jr z,#8100", "Z0403");
    await codeRaisesError("jr z,#7F81", "Z0403");
    await codeRaisesError("jr z,#7F00", "Z0403");

    await codeRaisesError("jr nc,#8082", "Z0403");
    await codeRaisesError("jr nc,#8100", "Z0403");
    await codeRaisesError("jr nc,#7F81", "Z0403");
    await codeRaisesError("jr nc,#7F00", "Z0403");

    await codeRaisesError("jr c,#8082", "Z0403");
    await codeRaisesError("jr c,#8100", "Z0403");
    await codeRaisesError("jr c,#7F81", "Z0403");
    await codeRaisesError("jr c,#7F00", "Z0403");
  });

  it("jr: fails with invalid condition", async () => {
    // --- Start address is #8000
    await codeRaisesError("jr po,$", "Z0402");
    await codeRaisesError("jr pe,$", "Z0402");
    await codeRaisesError("jr p,$", "Z0402");
    await codeRaisesError("jr m,$", "Z0402");
  });
  ...
  it("rst: fails with invalid target", async () => {
    await codeRaisesError("rst 2", "Z0404");
    await codeRaisesError("rst #40", "Z0404");
  });
  ...
  it("djnz: fails with far address", async () => {
    // --- Start address is #8000!
    await codeRaisesError("djnz #8082", "Z0403");
    await codeRaisesError("djnz #8100", "Z0403");
    await codeRaisesError("djnz #7F81", "Z0403");
    await codeRaisesError("djnz #7F00", "Z0403");
  });
