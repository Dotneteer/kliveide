...
/**
 * This script disassembles the first 16KB of the enAltZX.rom file
 * and saves the output to altRom0.txt in the next-disassembly folder
 */
async function disassembleAltRom() {
  try {
    ...
    let output = "";
    output += "ZX Spectrum Alt ROM Disassembly (First 16KB)\n";
    output += "=" .repeat(80) + "\n";
    ...
    // --- Save to file
    const outputPath = path.join(__dirname, "altRom0.txt");
