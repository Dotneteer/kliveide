...
const productionExports = [
  ...
  "sp128GetBaseClockFrequency",
  "sp128GetFrames",
  "sp128GetTacts",
  "sp128GetCurrentFrameTact",
  "sp128GetRasterLines",
  "sp128GetScreenLineTime",
  "sp128GetTimingScreenWidth",
  "sp128GetTimingScreenLines",
  "sp128GetFirstDisplayLine",
  ...
  "sp128GetMicBit",
  "sp128GetBeeperLevel",
  "sp128GetEarBitChangedFrom0Tacts",
  "sp128GetEarBitChangedFrom1Tacts",
  ...
  "sp128TapeFileNamePtr",
  "sp128TapeClear",
  "sp128TapeSetFileNameByte",
  ...
  "sp128TapeGetMode",
  "sp128TapeGetPlayPhase",
  "sp128TapeGetCurrentBlockIndex",
  "sp128TapeGetCurrentEarBit",
  "sp128TapeGetCurrentDataIndex",
  "sp128TapeGetCurrentBitMask",
  "sp128TapeGetStartTact",
  "sp128TapeGetModeChangeCount",
  "sp128TapeGetLastModeChangeTact",
  "sp128TapeGetLastModeChangePc",
  "sp128TapeGetLoadStartCount",
  "sp128TapeGetSaveStartCount",
  "sp128TapeClassifySavePulse",
  "sp128TapeGetSavePhase",
  "sp128TapeGetSaveLastPulse",
  "sp128TapeGetSaveMicBit",
  "sp128TapeGetSaveLastMicBitTact",
  "sp128TapeGetSavePilotPulseCount",
  "sp128TapeGetEarBit",
  "sp128TapeGetBlockOffset",
  "sp128TapeGetBlockLength",
  "sp128TapeGetBlockPauseAfter",
  "sp128TapeGetBlockPilotPulseLength",
  "sp128TapeGetBlockSync1PulseLength",
  "sp128TapeGetBlockSync2PulseLength",
  "sp128TapeGetBlockZeroBitPulseLength",
  "sp128TapeGetBlockOneBitPulseLength",
  "sp128TapeGetBlockEndSyncPulseLength",
  "sp128TapeGetBlockLastByteUsedBits",
  "sp128TapeGetBlockPilotPulseCount",
