...
function buildSp48Wasm({ compiler = process.env.SP48_WASM_CC || "clang", run = spawnSync } = {}) {
  ...
  const args = [
    ...
    "-Wl,--export=z80_state_read_control",
    "-Wl,--export=z80_state_write_control",
    "-Wl,--export=z80_state_read_counter",
    ...
    "-Wl,--export=z80_test_pop_word",
    "-Wl,--export=z80_test_sign_extend",
    "-Wl,--export=z80_test_condition",
    "-Wl,--export=z80_test_parity",
    "-Wl,--export=z80_test_add8",
    "-Wl,--export=z80_test_sub8",
    "-Wl,--export=z80_test_port_read",
    "-Wl,--export=z80_test_port_write",
